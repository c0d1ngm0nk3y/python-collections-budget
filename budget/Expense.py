...
class Expenses:
    ...
    def categorize_set_comprehension(self):
        ...
        return [set(necessary_expenses), set(food_expenses), set(unnecessary_expenses)]
    ...
    def categorize_for_loop(self):
        ...
        for i in self.list:
            if i.category == "Phone" or i.category == "Auto and Gas" or i.category == "Classes" or i.category == "Utilities" or i.category == "Mortgage":
